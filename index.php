...
<body> 
        <nav>
            <h2>Pizzaria di preprocessore 🍕</h2> <div class="inlog-uitlog"> <a href='inlogpagina.php' class='inloglink'>Inloggen</a> <a href="logout.php" class='inloglink'>Uitloggen</a>
            <?php session_start(); if(!empty($_SESSION['name'])){ if($_SESSION['name'] === "xXGOD_OF_P1ZZAXx") {echo"<a href='admin.php' class='inloglink'>Admin</a>";}} ?></div>
        </nav>  
